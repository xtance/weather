...
var app = (function () {
    ...
    // (81:3) <Item leftText="Поиск" rightText="" line={false}>
    function create_default_slot_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 81, 4, 2043);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(81:3) <Item leftText=\\\"Поиск\\\" rightText=\\\"\\\" line={false}>",
    		ctx
    	});
    ...
    // (92:3) {#each CITIES as city, index}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(92:3) {#each CITIES as city, index}",
    		ctx
    	});
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 101, 2, 2422);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 122, 3, 2789);
    		},
    		m: function mount(target, anchor) {
    ...
    // (115:3) {#each Object.entries(weatherParams) as [name, value], index}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(115:3) {#each Object.entries(weatherParams) as [name, value], index}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 129, 4, 2914);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 127, 2, 2855);
    		},
    		m: function mount(target, anchor) {
    			mount_component(logo, target, anchor);
    			insert_dev(target, t0, anchor);
