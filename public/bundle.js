...
var app = (function () {
    ...
    const file$4 = "resources\\svelte\\Panel.svelte";
    ...
    const file$3 = "resources\\svelte\\List.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (default_slot) default_slot.c();
    			attr_dev(div0, "class", "");
    			add_location(div0, file$3, 6, 1, 106);
    			attr_dev(div1, "class", "h-auto overflow-x-hidden ");
    			add_location(div1, file$3, 1, 0, 27);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "resources\\svelte\\Logo.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$2, 14, 2, 308);
    			add_location(br, file$2, 14, 54, 360);
    			add_location(span1, file$2, 15, 2, 368);
    			attr_dev(p, "class", "text-center py-8 stroke");
    			add_location(p, file$2, 13, 1, 269);
    ...
    class Logo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { title: 0, subtitle: 1 });
